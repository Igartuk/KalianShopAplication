...
using KalianShopApplication.Domain.Repositories.EntityFramework;
using KalianShopApplication.Service;
...
namespace KalianShopApplication
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.Cookie.Name = "KalianShopAuth";
